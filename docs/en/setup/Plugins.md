...
| [celery](https://docs.celeryq.dev) | Python >=3.10 - ['5.6.*'];  | `sw_celery` |
...
| [kafka-python](https://kafka-python.readthedocs.io) | Python >=3.10 - ['2.3.*'];  | `sw_kafka` |
...
| [pymongo](https://pymongo.readthedocs.io) | Python >=3.10 - ['4.16.*'];  | `sw_pymongo` |
...
| [redis](https://github.com/andymccurdy/redis-py/) | Python >=3.10 - ['5.3.*', '7.4.*'];  | `sw_redis` |
